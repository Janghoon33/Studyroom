...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/PersonRegist.css" />
    
    <link rel="stylesheet" type="text/css" href="./게시판.css" />
    ...
    <section class="bg-[#F4F7FF] py-14 lg:py-20">
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
              ...
              <div id="SubWrap">
                ...
                <div id="SubContents;">
                    <!-- Contents -->
                    <form name="regResume" id="regResume" onsubmit="return false;">
                    <div id="Contents" style="padding-left: 1rem; padding-right: 1rem; width: 72%; margin-left: 180px;">
     ...
     <!--수조------------------------------------------------------------------------------------------------------------------------>                 
                        ...
                        <div style="border-bottom: 2px solid #333; padding-bottom: 20px;">
                          ...
                          <center><label><input type="text"style="height: 50px; width: 500px;" placeholder="이름 넣을 거임?"></label></center>
                        </div>
                        <center>
                        <br>
                     
                        <div>
                        <img src="assets/img/수조.png" style="width: 750px; height: 350px;">
                     
                        </div>
                           <br>
                           <br>
                        <div>
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="몇리터 넣을 거임?"></label>
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="무슨 약 넣을 거임?"></label>
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="뭐 넣을 거임?"></label>
                           <br>
                           <br>
                     
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="뭐 할 거임?"></label>
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="어쩔 거임?"></label>
                           <label><input type="text"style="height: 50px; width: 230px;" placeholder="저쩔 거임?"></label>
                        </div>
                     </center>
                     <br>
                     <br>
     <!--수조 끝-------------------------------------------------------------------------------------------------------------->                   
            ...
            <script type="text/javascript">
                ...
                function delMainPhoto(){
                    if(confirm("등록된 관상어 사진을 삭제하시겠습니까?")){
                        getObject("photoAlbum").src = "/person/popup/PicRegistAlbumDel.asp?mode=MD&albumidx=" + getObject("hidmainphotoidx").value + "&registmainphotoyn=Y";
                    }
                }
            
                // 포토앨범 체크 (신규)
                function chkAlbumEss() {
                    if($(".reglistphoto:visible").length == 0) {
                        $("ul.statusMenu li:eq(3) a:eq(0)").removeClass("on");
                    } else 	{
                        $("ul.statusMenu li:eq(3) a:eq(0)").addClass("on");
                    }
                }
            
                function chkAlbumLoadingEss() {
                    if(Number($("#intphotocnt").val()) == 0) {
                        $("ul.statusMenu li:eq(3) a:eq(0)").removeClass("on");
                    } else 	{
                        $("ul.statusMenu li:eq(3) a:eq(0)").addClass("on");
                    }
              ...
              <div id="step1">
                        ...
                        <!-- 개인정보 -->
                          <div id="RegistBaseInfo" class="registArea">
                            <center><h2>=============안녕하세요? 어서오세요? 장훈어를 보여드릴게요============</h2></center>
                            
                            <div class="registForm">
                                <div class="photoArea" style="width: 160px; position: relative; left: 120px;">
                                    <span class="photo" id="idmainresumephoto">
                                        <!-- 사진 -->
                                        <img src="./assets/img/장훈어.png" id="resumephoto" alt="" />
                                        <!-- //사진 -->
                                    </span>
                                    <!-- 사진아이콘 -->
                                    <span class="applyBtn">
                                        <!-- 사진없을 때 -->
                                        <span id="picReigst" style="display:none">
                                        ...
                                        <span id="picModify">
                                            <span class="modifyBtn">
                                                <a class="imgModify" href="./관상어사진등록/관상어사진등록.html" onclick="window.open(this.href, 'popupName','width=567,height=740,top=0,left=0,status=no,scrollbars=yes,resizable=no'); return false"><span></span>변경</a>
                                ...
                                <div class="baseInfo">
                                    <table cellpadding="0" cellspacing="0" summary="개인정보인 휴대폰,유선전화,안심번호,이메일,주소,홈페이지 항목의 표입니다.">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="who" colspan="2" style="position: relative;left: 15px;">
                                                    <span class="name">이름 : <input type="text"></span>
                                                    <span class="genderAge"><em class='female'><input type="radio" name="gender"> 남 <input type="radio" name="gender"> 여
                                                    </span>
                                                  </td>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="item">투여먹이</td>
                                                <td class="infoContents homepage">
                                                    <div class="contentsBox">
                                                        <span><input type="text" id="homepage" name="homepage" value="" maxlength="100" /></span>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <!-- 투여량 -->
                        <div id="RegistTitle" class="registArea" style="padding-left: 15%;">
                            <h2 class="asd_txt">투여량</h2>
                            <br>
                            <br>
                            리터 : <input type="text">
                            리터 : <input type="text">
         ...
         <!-- 완료버튼------------------------------------------------------------------------------- -->
      <div style="padding-left: 1rem; padding-right: 1rem; width: 60%; margin-left: 250px;">
        <p class="completeBtn" style="padding-left: 520px;">
         <button type="button" class="btn yellowBtn" onclick="Test2()">
           추가
         </button>
           <a href="Archive.jsp" class="btn yellowBtn" onclick="doSubmit(); return false;">
               완료
          </a>
        </p>
      ...
      function Test2(){
       $("#Contents").append(`<div id="step1">
                          ...
                          <div id="RegistBaseInfo" class="registArea">
                            ...
                            <div class="registForm">
                              <div class="photoArea" style="width: 160px; position: relative; left: 120px;">
                                    <span class="photo" id="idmainresumephoto" style="height: 140px;">
                                    
                                        <img src="#" id="resumephoto" alt="">
                                    ...
                                    <span class="applyBtn">
                                        ...
                                        <span id="picModify">
                                            <span class="modifyBtn">
                                                <a class="imgModify" href="관상어사진등록.html" onclick="window.open(this.href, 'popupName','width=567,height=740,top=0,left=0,status=no,scrollbars=yes,resizable=no'); return false"><span></span>변경</a>
                                                <a class="imgdel" href="#" onclick="delMainPhoto(); return false;"><span></span>삭제</a>
                                            </span>
                                        </span>
