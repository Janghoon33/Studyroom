...
<%@page import="com.smhrd.domain.SelectExmember"%>
<%@page import="com.smhrd.domain.SelectExDAO"%>
<%@page import="java.util.List"%>
<%@page import="com.smhrd.domain.ExMemberDAO"%>
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/expertpage.css" />
    ...
    <%
    	SelectExmember m_vo =(SelectExmember)session.getAttribute("exmList");
    	//String ex_id = "12";
    	SelectExDAO dao = new SelectExDAO();
    	List<SelectExmember> selist = dao.selectEx();
    	pageContext.setAttribute("selist",selist);
    	/* System.out.println("게시물 개수 : "+selist.size());
    	System.out.println("게시물은 : "+selist); */
  ...
  >
    ...
    <!-- ====== Forms Section Start -->
    <section class="tab_wrap" style="background-color:  rgb(244 247 255);">
      <article class="mw1300 tab">
          <div class="gall_list typeB
                  tab1">
                <!--  <form action="SelectCon2" method="post">  -->
             <c:forEach var="selist" items="${selist }" begin="0" end="2" varStatus="status"> 
                  
              <ul class="gall_ul" style="margin-left: 510px; margin-right: 500px;">
                  <li class="gall_li" >
                      <ul class="gall_con" >
                          <li class="gall_img" style="height: 180px;">
                              <a href="전문가상세틀합.html">
                                  <img src="/assets/img/장훈어.png">
                              </a>
                             <%--  <span>
                                  ${status.count}
								</span> --%>
                          </li>
                          <li class="gall_txt" style="height: 180px;">
                              <div class="gall_sort" style="height: 0px;">
                              	<c:out value="${selist.ex_team}"/>
                              </div>
                              <h6 class="gall_tit" style="margin-top: 30px;">
                                  <a href="전문가상세틀합.html">
                                  
                                     <c:out value="${selist.ex_name}"/>
                                      
                                  </a>
                              </h6>
                              <p class="gall_stxt">
									 <c:out value="${selist.title}"/> 
                              
                              
                              </p>
                              <div class="btn_wrap gall_btn_wrap">
                                  <a href="전문가상세틀합.html" class="btn btn_green">상담하기</a>
                              </div>
                    </ul>
                    </li>
               </ul>
...
<!-- 
                  ...
                  <li class="gall_li">
                      <ul class="gall_con">
                          ...
                          <li class="gall_txt"style="height: 180px;">
                              ...
                              <p class="gall_stxt">뭘봐요
                                  <br>대충 케어함 꼽으면 상담누르지마셈
                              </p>
                  ...
                  <li class="gall_li">
                      <ul class="gall_con">
                          ...
                          <li class="gall_txt"style="height: 180px;">
                              ...
                              <p class="gall_stxt">태린이 바보다
                                  <br>안녕하세요 반가워요 잘있어요 다시 만나요~
                              </p>
    ...
    <div id="container-floating">
      <div id="floating-button">
        <p class="plus">+</p><a href="전문가직접작성페이지.html">
        <img class="edit" src="https://ssl.gstatic.com/bt/C3341AA7A1A076756462EE2E5CD71C11/1x/bt_compose2_1x.png"></a>
      </div>
    </div>
