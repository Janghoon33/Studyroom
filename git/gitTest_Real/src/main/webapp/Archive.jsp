...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/관상어mainPage.css" />
    ...
    <script src="./아카이브mainPage.js"></script>
    <script>
      new WOW().init();
    </script>
  </head>
        ...
        <div class="-mx-4 flex flex-wrap">
          ...
          <div class="w-full px-4">
            ...
            <div id="fish"
              ...
              data-wow-delay=".15s" style="height: 600px; width: 920px;"
            >
<!------------------------수족관--------------------------------------------------------------------------------------->
...
<div class="btnWrap">
  <div id="plus">
  <button type="button" onclick="location.href=''"><img src=".assets/img/플러스.png" style="width: 90px; height: 80px;"></button>
  </div>
  </div>
